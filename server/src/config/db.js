...
try {
    ...
    `).then(() => {
        ...
        return sequelize.query(`
          ...
          UPDATE MembershipPlans SET plan_name = N'Boxing 12 Tháng', description = N'Truy cập phòng Boxing. Tặng 2 buổi PT Boxing miễn phí (không chọn PT).' WHERE membership_plan_id IN (4, 14);
          UPDATE MembershipPlans SET plan_name = N'Premium Toàn Diện 12 Tháng', description = N'Sử dụng tất cả dịch vụ Gym, Yoga, Boxing' WHERE membership_plan_id = 5;
          ...
          UPDATE MembershipPlans SET plan_name = N'Boxing 3 Tháng', description = N'Truy cập phòng Boxing. Tặng 2 buổi PT Boxing miễn phí (không chọn PT).' WHERE membership_plan_id = 12;
          UPDATE MembershipPlans SET plan_name = N'Boxing 6 Tháng', description = N'Truy cập phòng Boxing. Tặng 2 buổi PT Boxing miễn phí (không chọn PT).' WHERE membership_plan_id = 13;
          ...
          UPDATE WorkoutExercises SET exercise_name = N'Đấm thẳng (Jabs & Crosses)' WHERE exercise_name LIKE '%Jabs%';
          UPDATE WorkoutExercises SET exercise_name = N'Đấm móc (Hooks & Uppercuts)' WHERE exercise_name LIKE '%Hooks%';
          UPDATE WorkoutExercises SET exercise_name = N'Đấm bao cát (Heavy Bag Work)' WHERE exercise_name LIKE '%Heavy%' OR exercise_name LIKE '%bao cát%';
          UPDATE WorkoutExercises SET exercise_name = N'Di chuyển tránh đòn (Slipping & Weaving)' WHERE exercise_name LIKE '%Slipping%';
          UPDATE WorkoutExercises SET exercise_name = N'Đấm bóng phản xạ (Speed Bag)' WHERE exercise_name LIKE '%Speed Bag%' OR exercise_name LIKE '%bóng phản xạ%';
          UPDATE WorkoutExercises SET exercise_name = N'Né đòn phối hợp (Shadow Boxing with Slip)' WHERE exercise_name LIKE '%Shadow%' OR exercise_name LIKE '%Né đòn%';
          UPDATE WorkoutExercises SET exercise_name = N'Đỡ đấm đích tay (Pad Work with Coach)' WHERE exercise_name LIKE '%Pad%' OR exercise_name LIKE '%đích tay%';
          UPDATE WorkoutExercises SET exercise_name = N'Phối hợp đấm né (Slip-Counter Combination)' WHERE exercise_name LIKE '%Slip-Counter%' OR exercise_name LIKE '%đấm né%';
          UPDATE WorkoutExercises SET exercise_name = N'Di chuyển bộ chân (Footwork drills)' WHERE exercise_name LIKE '%Footwork%';
          UPDATE WorkoutExercises SET exercise_name = N'Tổ hợp đấm 1-2 (Jab-Cross Combo)' WHERE exercise_name LIKE '%Jab-Cross%';
          UPDATE WorkoutExercises SET exercise_name = N'Nhảy dây tốc độ cao (Speed Rope)' WHERE exercise_name LIKE '%Speed Rope%';
        `);
    }).then(() => {
